...
async function getAgencyReviews(agencySlug: string) {
  ...
  return reviews.filter(
    (review) => slugify(review.agency) === agencySlug
  );
}
...
export async function generateMetadata({
  ...
  const agencyName =
    reviews[0].agency || agencyFromSlug(agency);
...
export default async function AgencyPage({
  ...
  const agencyName =
    agencyReviews[0].agency ||
    agencyFromSlug(agency);
    ...
    <section>
      ...
      <div className="pageHeader">
        ...
        <h1 className="pageTitle">
          {agencyName} Travel Nurse
          Contract Reviews
        </h1>

        <p className="pageSubtitle">
          Anonymous travel nurse
          reviews involving {agencyName}.
          Compare hospitals, units,
          pay packages, floating
          frequency, housing
          experiences, and whether
          nurses would take another
          contract.
        </p>
      </div>
